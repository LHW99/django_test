...
# Class for book genres; since no verbose name is defined, field will be called Name in forms
...
class BookInstance(models.Model):
  ...
  # UUIDField is used for the id field to set as primary_key for model
